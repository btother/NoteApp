...
public ObservableCollection<Category> Categories { get; set; } = new();
   ...
   protected void OnPropertyChanged([CallerMemberName] string? name = null)
    ...
    public class Category : INotifyPropertyChanged {
        ...
        /// <summary>
  /// Unterkategorien = Dokumente (erscheinen als Tabs).
        /// </summary>
        public ObservableCollection<Category> SubCategories { get; set; } = new();
        /// <summary>
     /// Seiten dieses Dokuments. Nur bei IsDocument=true befuellt.
        /// </summary>
      public ObservableCollection<NotePage> Pages { get; set; } = new();
        /// <summary>
        /// true = Unterkategorie/Dokument (Tab), false = Ordner im Tree.
        /// </summary>
...
protected void OnPropertyChanged([CallerMemberName] string? name = null)
    ...
    public enum PageType { Lined, ExternalPdf }
